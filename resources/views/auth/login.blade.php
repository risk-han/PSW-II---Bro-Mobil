...
<div class="page-content">
		<div class="form-v6-content">
			<div class="form-left">
				<img style="width: 480px;" src="{{ asset('images/bg-login.jpg') }}" alt="form">
			</div>
			<form class="form-detail" method="POST" action="{{ route('login') }}">
                @csrf
				<h2>Bro Mobil - Login</h2>
                <br>
                <br>
                <br>
                <br>
                ...
                <br>
				<div class="form-row">
					<input type="text" name="email" id="email" class="form-control input-text @error('email') is-invalid @enderror" placeholder="Email" value="{{ old('email') }}">
                    @error('email')
				...
				<div class="form-row">
					<input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror input-text" placeholder="Password" value="">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
